...
const Header: React.FC<HeaderProps> = ({ theme, setTheme, onOpenInfo, onOpenFeedback, onGoToHistory }) => {
  ...
  const navLinks = (
    <>
      <button onClick={() => { onOpenInfo(); setMenuOpen(false); }} className={navLinkClass}><InfoIcon className="w-5 h-5 mr-2" />Info</button>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-2">
             <svg className="w-8 h-8 text-neon-cyan" xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div>
              ...
              <p className="text-xs text-text-secondary -mt-1">Verify before you trust.</p>
            </div>
          </div>
